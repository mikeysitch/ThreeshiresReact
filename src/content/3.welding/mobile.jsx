...
export default function WeldingMobile () {
  return (
    <div className="w-full" id="welding_mobile">
      <div id="bW_mobile" className="py-9 px-5"  style={{ backgroundImage: "url('/assets/images/weld-grad.gif')" }}>
        <div id="title" className="text-white text-5xl text-center p-4 mb-4">
        ...
        <div class="p-6 mt-4 flex items-center justify-center">
